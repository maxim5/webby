...
public class ConnectionPoolTest {
    ...
    public void parseUrl_valid() {
        ...
        assertEquals(Engine.Unknown, parseUrl("jdbc:hsqldb:mem:foo"));
        assertEquals(Engine.Unknown, parseUrl("jdbc:derby:target/tmp/derby/hpjp;databaseName=foo;create=true"));
    }
