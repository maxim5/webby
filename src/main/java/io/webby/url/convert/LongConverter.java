...
public class LongConverter implements Converter<Long> {
    public static LongConverter ANY = new LongConverter(Long.MIN_VALUE, Long.MAX_VALUE);
    public static LongConverter POSITIVE = new LongConverter(1, Long.MAX_VALUE);
    public static LongConverter NON_NEGATIVE = new LongConverter(0, Long.MAX_VALUE);
