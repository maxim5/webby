...
public class AcceptJsonMessageTest extends BaseWebsocketIntegrationTest {
    ...
    public void on_json_text_simple_only_int() {
        AcceptJsonMessage agent = prepareAgent(Marshal.JSON, FrameType.TEXT_ONLY, new TextSeparatorFrameMetadata());
    ...
    public void on_json_binary_simple_only_int() {
        AcceptJsonMessage agent = prepareAgent(Marshal.JSON, FrameType.BINARY_ONLY, new BinarySeparatorFrameMetadata());
    ...
    public void on_json_binary_fixed() {
        AcceptJsonMessage agent = prepareAgent(Marshal.JSON, FrameType.BINARY_ONLY, new BinaryFixedSizeFrameMetadata(9));
    ...
    public void on_json_metadata() {
        AcceptJsonMessage agent = prepareAgent(Marshal.JSON, FrameType.TEXT_ONLY,
