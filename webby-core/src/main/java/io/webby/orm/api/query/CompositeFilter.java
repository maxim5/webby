...
public class CompositeFilter extends Unit implements Filter {
    ...
    public static class Builder {
        ...
        public @NotNull Builder with(@NotNull LimitClause limit) {
            assure(this.limit == null, "Duplicate limit specified: existing: %s, updated: %s", this.limit, limit);
            this.limit = limit;
            return this;
        }

        public @NotNull Builder with(@NotNull Offset offset) {
            assure(this.offset == null, "Duplicate offset specified: existing: %s, updated: %s", this.offset, offset);
            this.offset = offset;
            return this;
        }
