...
public class SelectGroupBy extends Unit implements TypedSelectQuery {
    ...
    public static class Builder {
        ...
        public @NotNull Builder aggregate(@NotNull FuncExpr aggregate) {
            InvalidQueryException.assure(funcExpr == null, "Aggregate function already set: %s", funcExpr);
            InvalidQueryException.assure(aggregate.isAggregate(), "Non-aggregate function supplied: %s", aggregate);
            funcExpr = aggregate;
            return this;
        }
